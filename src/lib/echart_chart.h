...
EAPI void echart_chart_title_style_set(Echart_Chart *chart,
                                       ...
                                       Eina_Bool bold,
                                       Eina_Bool italic);
EAPI void echart_chart_title_style_get(const Echart_Chart *chart,
                                       const char **font_name,
                                       int *font_size,
                                       unsigned int *color,
                                       Eina_Bool *bold,
...
EAPI void echart_chart_title_haxis_style_set(Echart_Chart *chart,
                                             ...
                                             Eina_Bool bold,
                                             Eina_Bool italic);
EAPI void echart_chart_title_haxis_style_get(const Echart_Chart *chart,
                                             const char **font_name,
                                             int *font_size,
                                             unsigned int *color,
                                             Eina_Bool *bold,
...
EAPI void echart_chart_title_vaxis_style_set(Echart_Chart *chart,
                                             ...
                                             Eina_Bool bold,
                                             Eina_Bool italic);
EAPI void echart_chart_title_vaxis_style_get(const Echart_Chart *chart,
                                             const char **font_name,
                                             int *font_size,
                                             unsigned int *color,
                                             Eina_Bool *bold,
